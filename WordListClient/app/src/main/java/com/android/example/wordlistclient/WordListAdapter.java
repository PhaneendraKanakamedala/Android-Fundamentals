...
public class WordListAdapter extends RecyclerView.Adapter<WordListAdapter.WordViewHolder> {
    ...
    public void onBindViewHolder(WordViewHolder holder, int position) {
        ...
        int id = -1;
        Cursor cursor =
                mContext.getContentResolver().query(Uri.parse(uri), projection, selectionClause,
    ...
    public int getItemCount() {
        int count = -1;
        Cursor cursor =
                mContext.getContentResolver().query(Contract.ROW_COUNT_URI, projection,
